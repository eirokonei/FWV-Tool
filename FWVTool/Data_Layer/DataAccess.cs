	...
	class DataAccess
	{
		...
		public static SqlConnection Sqcon
		{
			get
			{
				if (sqcon == null)
				{
					sqcon = new SqlConnection(@"Data Source=DESKTOP-JJG2ETN;Initial Catalog=FWV;Persist Security Info=True;User ID=sa;Password=12345");
				}
